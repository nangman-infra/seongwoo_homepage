...
def REPO_SLUG = 'nangman-infra/seongwoo_homepage'
def MAIN_BRANCH_REF = 'refs/heads/main'
def DEFAULT_REPO_HTTP_URL = 'https://github.com/nangman-infra/seongwoo_homepage.git'
...
pipeline {
    ...
    triggers {
        GenericTrigger(
            ...
            causeString: 'seongwoo_homepage main push detected',
                        ...
                        script {
                            ...
                            writeFile(
                                ...
                                text: """
                                    ...
                                    sonar.coverage.exclusions=src/app/blog/page.tsx,src/components/sections/About.tsx,src/components/sections/Footer.tsx,src/components/ui/ProjectCard.tsx
